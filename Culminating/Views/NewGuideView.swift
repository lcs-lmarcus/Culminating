                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Done") {
                        withAnimation {
                            ...
                            viewModel.add(newAttraction: Attraction( id: UUID(), name: AttractionName, address: AttractionAddress, latitude: AttractionLatitude, longitude: AttractionLongitude, rating: AttractionRating, description: AttractionDescription, isFavourite: AttractionFavourite))
